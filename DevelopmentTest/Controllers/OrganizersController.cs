...
namespace DevelopmentTest.Controllers
{
    public class OrganizersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrganizerName,ImageLocation")] Organizer organizer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrganizerName,ImageLocation")] Organizer organizer)
        {
            if (id != organizer.Id)
            {
                return NotFound();
